...
// Wrapper functions for add9 chords
void test_C_add9(void) { test_maj7_chord("C3", "E3", "G3", "B3"); }
void test_Cs_add9(void) { test_maj7_chord("C#3", "F3", "G#3", "C4"); }
void test_D_add9(void) { test_maj7_chord("D3", "F#3", "A3", "C#4"); }
void test_Ds_add9(void) { test_maj7_chord("D#3", "G3", "A#3", "D4"); }
void test_E_add9(void) { test_maj7_chord("E3", "G#3", "B3", "D#4"); }
void test_F_add9(void) { test_maj7_chord("F3", "A3", "C4", "E4"); }
void test_Fs_add9(void) { test_maj7_chord("F#3", "A#3", "C#4", "F4"); }
void test_G_add9(void) { test_maj7_chord("G3", "B3", "D4", "F#4"); }
void test_Gs_add9(void) { test_maj7_chord("G#3", "C4", "D#4", "G4"); }
void test_A_add9(void) { test_maj7_chord("A3", "C#4", "E4", "G#4"); }
void test_As_add9(void) { test_maj7_chord("A#3", "D4", "F4", "A4"); }
void test_B_add9(void) { test_maj7_chord("B3", "D#4", "F#4", "A#4"); }
...
int main() {
    ...
    // Add a test suite
    CU_pSuite pSuite = CU_add_suite("add9 Chords Test Suite", 0, 0);

    // Add add9 tests
    CU_add_test(pSuite, "C add9", test_C_add9);
    CU_add_test(pSuite, "C# add9", test_Cs_add9);
    CU_add_test(pSuite, "D add9", test_D_add9);
    CU_add_test(pSuite, "D# add9", test_Ds_add9);
    CU_add_test(pSuite, "E add9", test_E_add9);
    CU_add_test(pSuite, "F add9", test_F_add9);
    CU_add_test(pSuite, "F# add9", test_Fs_add9);
    CU_add_test(pSuite, "G add9", test_G_add9);
    CU_add_test(pSuite, "G# add9", test_Gs_add9);
    CU_add_test(pSuite, "A add9", test_A_add9);
    CU_add_test(pSuite, "A# add9", test_As_add9);
    CU_add_test(pSuite, "B add9", test_B_add9);
